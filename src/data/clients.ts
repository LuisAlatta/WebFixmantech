...
export const clientLogos: ClientLogo[] = [
    ...
    { src: '/nuevas imagenes/CLIENTES/logo HUDBAY.jpg', alt: 'Hudbay', scale: 'scale-150' },
    { src: '/nuevas imagenes/CLIENTES/logo LAS BAMBAS.jpg', alt: 'Las Bambas', scale: 'scale-125' },
    { src: '/nuevas imagenes/CLIENTES/logo VOLCAN.jpg', alt: 'Volcan', scale: 'scale-150' },
    { src: '/nuevas imagenes/CLIENTES/logo marcobre.png', alt: 'Marcobre', scale: 'scale-150' }
];
